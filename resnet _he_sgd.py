...
x_train, y_train,x_test, y_test = data.load_data("data/train/type0", "data/train/type1","data/train/type2","data/test/type0", "data/test/type1","data/test/type2")
...
sgd = SGD(lr=lr_schedule(0), momentum=0.9, nesterov=True)
...
file = open('lichen_resnet_data.txt','w')
file.write(str(hist.history))
file.close()